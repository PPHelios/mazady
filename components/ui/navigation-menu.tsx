...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-10 w-max items-center justify-center rounded-md bg-surface px-4 py-2 text-sm font-medium transition-colors hover:bg-surface/30 hover:text-orange-400 focus:bg-surface/30 text-white focus:text-white focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-surface/50 data-[state=open]:bg-surface/50",
);
...
>(({ className, ...props }, ref) => (
  <div
    className={cn(
      `absolute left-0 top-full flex justify-center ltr:right-auto rtl:left-auto
      rtl:right-0`,
    )}
  >
