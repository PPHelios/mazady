...
import { ChevronRightIcon, CircleChevronLeft } from "lucide-react";
...
>(({ className, index, children, ...props }, ref) => {
  ...
  return (
    ...
    >
      <div
        className={`relative aspect-square h-20 w-full rounded-md opacity-40
          transition-opacity ${isSlideActive ? "!opacity-100" : ""}`}
      >
        {children}
      </div>
    </div>
